...
from core.loss import ScoresHardMiningL1Loss
...
def main():
    ...
    criterion_score = ScoresHardMiningL1Loss().cuda()
    ...
    for epoch in range(begin_epoch, cfg.TRAIN.END_EPOCH):
        ...
        # train for one epoch
        train(cfg, train_loader, train_dataset.flip_pairs, model, criterion_heatmap, criterion_score, optimizer, epoch,
              final_output_dir, tb_log_dir, writer_dict)


        # evaluate on validation set
        perf_indicator = validate(
            cfg, valid_loader, valid_dataset, model, criterion_heatmap, criterion_score,
            final_output_dir, tb_log_dir, writer_dict
        )
